...
class AndroidScreens : IScreens {
    ...
    override fun mentee(mentee: Mentee): Screen =
        FragmentScreen { MenteeFragment.newInstance(mentee) }
    ...
    override fun feedback(feedback: IFeedBack, message: String): Screen = ActivityScreen {
